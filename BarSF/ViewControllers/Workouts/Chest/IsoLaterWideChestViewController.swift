//
//  IsoLaterWideChestViewController.swift
//  BarSF
//
...
import UIKit
import AVKit
class IsoLaterWideChestPressViewController: UIViewController {
    private let imageView: UIView = {
        let button   = UIView()
        button.addImage(pic: "widechest")
