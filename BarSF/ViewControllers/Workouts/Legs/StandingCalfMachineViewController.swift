//
//  StandingCalfMachineViewController.swift
//  BarSF
//
...
class StandingCalfMachineViewController: UIViewController {

    private let imageView: UIView = {
        let button   = UIView()
        button.addImage(pic: "standingcalf")
